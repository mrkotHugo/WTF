...
VUHDO_BUFF_ORDER = {
	...
	["Щит земли"] = 17,
	["Тотем ветроступа"] = 18,
	["Тотем конденсации"] = 19,
	["Тотем жидкой магмы"] = 22,
	["Тотем противоядия"] = 21,
	["Тотем исцеляющего потока"] = 20,
	["Тотем оков земли"] = 23,
	["Элементаль земли"] = 12,
	["Источник маны"] = 25,
	["Зачарование оружия"] = 11,
	["Жажда крови"] = 27,
}
VUHDO_SPEC_LAYOUTS = {
	["1"] = "",
